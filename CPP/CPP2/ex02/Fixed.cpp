...
//prefix increment: increment the value of the object and return the incremented object
...
//postfix increment: return the current value of the object and then increment the value of the object
...
//prefix decrement: decrement the value of the object and return the decremented object
Fixed &Fixed::operator--() 
{
    this->_value--;
    return *this;
...
//postfix decrement: return the current value of the object and then decrement the value of the object
Fixed Fixed::operator--(int)
{
    Fixed temp(*this);
    --(*this);
