...
/*   Updated: 2026/03/03 10:25:26 by idiaz-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_data
{
    ...
    long            time_to_eat;
    long            time_to_sleep;
    int				must_eat_count; //nº de veces que cada filosofo debe comer, si se especifica como argumento, si no se especifica es -1 y los filosofos pueden comer indefinidamente
...
typedef struct s_philo
{
    ...
    int             meals_eaten; //contador de comidas, se incrementa cada vez que el filosofo come, se usa para verificar si el filosofo ha comido el número requerido de veces (must_eat_count) para terminar la simulacion
